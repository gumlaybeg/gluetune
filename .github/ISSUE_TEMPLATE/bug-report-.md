---
name: Bug Report
about: Report a bug found in GlueTune to help us improve the application
...
```
**How to capture logs:**
- Use `adb logcat | grep -i gluetune` for filtered logs
...
- [ ] I have tested on the latest version of GlueTune
